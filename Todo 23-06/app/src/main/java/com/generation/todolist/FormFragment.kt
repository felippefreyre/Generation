...
class FormFragment : Fragment(), TimePickerListener {
    ...
    private fun validarCompos(nome: String, descricao: String, responsavel: String
    ): Boolean{
    ...
    private fun insereirNoBanco() {
        ...
        }else{Toast.makeText(context, "Verifique os campos", Toast.LENGTH_SHORT).show()}
    }
